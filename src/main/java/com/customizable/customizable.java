...
public class customizable {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "customizable" namespace
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "customizable" namespace
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "customizable" namespace
    ...
    // Creates a new food item with the id "customizable:example_id", nutrition 1 and saturation 2
